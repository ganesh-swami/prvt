...
import { ArrowUp, ArrowDown, TreePine, Target } from "lucide-react";
      ...
      <Card>
        <CardHeader>
          <div className="flex items-center gap-2">
            ...
            <CustomTooltip
              title=""
              description="Visual representation helps identify causal relationships and prioritize interventions. This diagram shows how root causes lead to the core problem, which creates various effects. Essential for strategic planning and stakeholder communication."
            />
          </div>
        </CardHeader>
        <CardContent>
      ...
      <Card>
        <CardHeader>
          <div className="flex items-center gap-2">
            ...
            <CustomTooltip
              title=""
              description="Helps prioritize which causes to address first based on impact potential and feasibility. High-impact, high-feasibility causes should be primary targets. This matrix guides resource allocation and intervention sequencing for maximum social impact."
            />
          </div>
        </CardHeader>
        <CardContent>
