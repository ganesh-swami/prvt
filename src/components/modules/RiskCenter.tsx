          ...
          <div>
            <div className="flex items-center gap-2">
              <CustomTooltip content="Comprehensive risk management system for identifying, assessing, and mitigating organizational risks">
                <h1 className="text-2xl sm:text-3xl font-bold cursor-help">
                  Risk Center
                </h1>
              </CustomTooltip>
              {loading && (
        ...
        <TabsContent value="dashboard" className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex justify-between">
                    ...
                    <Badge variant="destructive">
                      {
                        risks.filter(
                          (r) => getRiskScore(r.likelihood, r.impact) >= 50
                        ).length
                      }
                    </Badge>
                  </div>
                  ...
                  <div className="flex justify-between">
                    ...
                    <Badge variant="secondary">
                      {
                        risks.filter(
                          (r) => getRiskScore(r.likelihood, r.impact) < 25
                        ).length
                      }
                    </Badge>
                  </div>
            ...
            <Card>
              ...
              <CardContent>
                <div className="space-y-3">
                  {["Active", "Monitoring", "Mitigated", "Resolved"].map(
                    (status) => (
            ...
            <Card>
              ...
              <CardContent>
                <div className="space-y-3">
                  {Array.from(new Set(risks.map((r) => r.category))).map(
                    (category) => (
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        ...
                        <Textarea
                          ...
                          onChange={(e) =>
                            dispatch(
                              setNewRisk({ description: e.target.value })
                            )
                          }
                        />
                      </div>
                      <div>
                        ...
                        <Select
                          ...
                          onValueChange={(value) =>
                            dispatch(setNewRisk({ category: value }))
                          }
                        >
                          <SelectTrigger>
                      ...
                      <div>
                        <div className="flex items-center gap-2 mb-1.5">
                          <Label htmlFor="impact" className="text-left block">
                            Impact (1-10)
                          </Label>
                        ...
                        <Input
                          ...
                          onChange={(e) =>
                            dispatch(
                              setNewRisk({ impact: parseInt(e.target.value) })
                            )
                          }
                        />
                      </div>
                      <div>
                        <div className="flex items-center gap-2 mb-1.5">
                          <Label htmlFor="owner" className="text-left block">
                            Risk Owner
                          </Label>
                        ...
                        <Input
                          ...
                          value={newRisk.owner || ""}
                          onChange={(e) =>
                            dispatch(setNewRisk({ owner: e.target.value }))
                          }
                        />
                      </div>
                      <div>
                        ...
                        <Textarea
                          ...
                          onChange={(e) =>
                            dispatch(
                              setNewRisk({ mitigationStrategy: e.target.value })
                            )
                          }
                        />
                      </div>
                ...
                <Card>
                  <CardContent className="flex flex-col items-center justify-center py-12">
                    ...
                    <p className="text-gray-500 text-center mb-6 max-w-md">
                      Start building your risk register by identifying and
                      documenting potential risks to your organization.
                    </p>
                    <Button
                    ...
                    (category) => {
                      ...
                      const avgScore =
                        categoryRisks.reduce(
                          (sum, r) =>
                            sum + getRiskScore(r.likelihood, r.impact),
                          0
