...
import { addFinancialModelerContent } from "@/utils/modulePDFExports";
...
const FinancialModelerEnhanced: React.FC<FinancialModelerProps> = ({
  ...
  const calculateFinancialModel = (
    ...
    return {
      ...
      marginPercent: totalRev > 0 ? (totalNetProfit / totalRev) * 100 : 0,
  ...
  const exportToPDF = async () => {
    ...
    try {
      ...
      doc = addFinancialModelerContent(doc, results, false);
      doc = addFooterToAllPages(doc, "Financial Model Report");
      downloadPDF(doc, "financial-model-report");
