...
import { planSections2 } from "./PlanBuilderSections2";
import { planSections3 } from "./PlanBuilderSections3";
import { planSections4 } from "./PlanBuilderSections4";
import { planSections5 } from "./PlanBuilderSections5";
import { planSections6 } from "./PlanBuilderSections6";
import { planSections7 } from "./PlanBuilderSections7";
import { planSectionsFinal } from "./PlanBuilderSectionsFinal";

// Complete plan sections in the requested sequence
export const allPlanSections: PlanSection[] = [
  {
    id: "executive",
